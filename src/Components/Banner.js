          ...
          <div>
            ...
            <div className="flex items-center md:gap-3 gap-5">
              <a href="https://www.facebook.com/awlads" target="_blank">
                <IoLogoFacebook className="w-10 h-10 bg-[#1F2125] inline text-lg p-1 rounded-md text-white shadow-2xl" />
              </a>
              <a href="https://www.linkedin.com/in/mdawlad/" target="_blank">
                <FaLinkedin className="w-10 h-10 bg-[#1F2125] inline text-lg p-1 rounded-md text-white shadow-2xl" />
              </a>
              <a href="https://github.com/Md-Awlad" target="_blank">
                <ImGithub className="w-10 h-10 bg-[#1F2125] inline text-lg p-1 rounded-md text-white shadow-2xl" />
              </a>
            </div>
          </div>
          <div>
