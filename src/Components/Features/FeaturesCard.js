    ...
    <Zoom>
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:gap-10 gap-5">
        ...
        <div className="bg-white hover:bg-[#BB1916] px-8 py-10 space-y-6 rounded-bl-[4rem] rounded-tr-[4rem] shadow-2xl text-[#102750] hover:text-white">
          ...
          <h2 className="text-3xl font-bold capitalize">web design</h2>
        ...
        <div className="bg-white hover:bg-[#BB1916] px-8 py-10 space-y-6 rounded-bl-[4rem] rounded-tr-[4rem] shadow-2xl text-[#102750] hover:text-white">
          ...
          <h2 className="text-3xl font-bold capitalize">customize website</h2>
          <p className="text-lg font-semibold">
        ...
        <div className="bg-white hover:bg-[#BB1916] px-8 py-10 space-y-6 rounded-bl-[4rem] rounded-tr-[4rem] shadow-2xl text-[#102750] hover:text-white">
          ...
          <h2 className="text-3xl font-bold capitalize">mobile app</h2>
          <p className="text-lg font-semibold">
        ...
        <div className="bg-white hover:bg-[#BB1916] px-8 py-10 space-y-6 rounded-bl-[4rem] rounded-tr-[4rem] shadow-2xl text-[#102750] hover:text-white">
          ...
          <h2 className="text-3xl font-bold capitalize">wordpress</h2>
          <p className="text-lg font-semibold">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime,
            vel.
          </p>
