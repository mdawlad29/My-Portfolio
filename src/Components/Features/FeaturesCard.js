...
const FeaturesCard = () => {
  return (
    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
      {/* --design-- */}
      <div className="bg-[#212428] text-gray-300 px-8 py-10 space-y-6 rounded-lg shadow-2xl hover:bg-[#1C1E22]">
      ...
      {/* --frontend-- */}
      <div className="bg-[#212428] text-gray-300 rounded-lg shadow-2xl px-8 py-10 space-y-6 hover:bg-[#1C1E22] ">
